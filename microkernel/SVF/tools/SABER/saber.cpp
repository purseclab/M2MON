...
static cl::opt<bool> MINION("minion", cl::init(false),
                                 cl::desc("Minion Analysis Pass"));

#ifdef MINION_CGRAPH
static cl::opt<bool> CGRAPH("cgraph", cl::init(false),
                                 cl::desc("Call Graph Construction"));
#endif
...
int main(int argc, char ** argv) {
    ...
    if(LEAKCHECKER)
        ...
        Passes.add(new Minion());
#ifdef MINION_CGRAPH
    else if(CGRAPH)
        Passes.add(new CGraph());
#endif
